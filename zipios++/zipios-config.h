/* zipios++/zipios-config.h.  Generated from zipios-config.h.in by configure.  */
...
#define PACKAGE_STRING "zipios++ 0.1.5.9.1"
...
#define PACKAGE_VERSION "0.1.5.9.1"
